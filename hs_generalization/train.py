# Code modified from https://github.com/urjakh/defverify
# and they modified code from https://github.com/huggingface/transformers/blob/master/examples/pytorch/text-classification/run_glue_no_trainer.py
# coding=utf-8
...
import torch
import os
os.environ.setdefault("WANDB_SILENT", "true") #it can be removed if needed
